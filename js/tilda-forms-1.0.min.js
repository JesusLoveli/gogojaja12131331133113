window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
    ...
    for (var e = t.querySelectorAll(".js-tilda-rule"), r = [], o = !0, a = 0; a < e.length; a++) {
        var n = e[a],
            ...
            l = "",
            c = "",
            d = n.getAttribute("data-tilda-rule-minlength") || 0,
            u = n.getAttribute("data-tilda-rule-maxlength") || 0,
            m = {},
            p = n.value,
            f = "",
            _ = n.getAttribute("type"),
            w = n.getAttribute("name"),
            y = t.getAttribute("data-formcart");
        m.obj = n, m.type = [], p && p.length && (f = p.replace(/[\s\u0000—\u001F\u2000-\u200F\uFEFF\u2028-\u202F\u205F-\u206F]/gi, ""), p = p.trim()), p.length > 0 && (o = !1), d && (d = parseInt(d, 10)), u && (u = parseInt(u, 10));
        var h = !p.length && !f.length,
            g = "checkbox" === _ || "radio" === _,
            v = !t.querySelectorAll('[name="' + w + '"]:checked').length;
        if (i && (h || g && v)) m.type.push("req");
            ...
            switch (s) {
                case "email":
                    ...
                    break;
                case "url":
                    l = /^((https?|ftp):\/\/)?[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9_\.\-]{0,253}\.[a-zA-Zёа-яЁА-Я]{2,10}\/?$/gi, p.length && ((c = (c = (c = p.split("//")) && c.length > 1 ? c[1] : c[0]).split("/")) && c.length && c[0] ? (c = c[0]).match(l) || m.type.push("url") : (c && !c[0] || m.type.push("url"), c = ""));
                    break;
                case "phone":
                    var b = n.getAttribute("data-tilda-mask"),
                        E = "^[0-9()+-";
                    b && (-1 !== b.indexOf("*") ? E += "a-zёа-я" : (-1 !== b.indexOf("a") && (E += "a-z"), -1 !== b.indexOf("а") && (E += "а-яё"))), E += "]+$", l = new RegExp(E, "gi"), f.length && !f.match(l) ? m.type.push("phone") : (1 == (c = f.replace(/[^0-9]+/g, "")).indexOf("000") || 1 == c.indexOf("111") && "9" != c.substring(0, 1) || 1 == c.indexOf("222") && "5" != c.substring(0, 1) || 1 == c.indexOf("333") || 1 == c.indexOf("444") || 1 == c.indexOf("555") && "0" != c.substring(0, 1) || 1 == c.indexOf("666") && "0" != c.substring(0, 1) || 1 == c.indexOf("8888") && "4" != c.substring(0, 1)) && m.type.push("phone");
                    break;
                case "number":
                ...
                case "chosevalue":
                    ...
                    break;
                case "promocode":
                    "y" !== y || !f.length || !window.tcart || window.tcart.promocode && window.tcart.prodamount_discountsum || m.type.push("promocode");
                    break;
                case "deliveryreq":
                    m.type.push("deliveryreq")
            }
            d > 0 && p.length && p.length < d && m.type.push("minlength"), u > 0 && p.length && p.length > u && m.type.push("maxlength")
        }
        m.type && m.type.length && (r[r.length] = m)
    }
    if ("y" === y) {
        var F = void 0 !== window.tcart_minorder && window.tcart_minorder > 0,
    ...
    function x(t) {
        ...
        if ("INPUT" === ((t = t || window.event).target || t.srcElement).tagName) {
            var o = F.querySelectorAll("form .t-input-error");
    ...
    if (window.t_forms__errorTimerID && window.clearTimeout(window.t_forms__errorTimerID), window.t_forms__errorTimerID = window.setTimeout((function() {
        ...
        var F = t.closest(".r"),
            S = "focus";
        document.addEventListener || (S = "focusin"), t_removeEventListener(F, S, x), t_addEventListener(F, S, x, !0), t_removeEventListener(F, "change", x), t_addEventListener(F, "change", x, !0)
    }
    ...
    r || (r = ".blockinput");
    for (var o = "", a = !1, n = !0, i = "", s = "", l = "", c = [], d = 0; d < e.length; d++)
        if (e[d] && e[d].obj) {
            if (0 === d && "none" === e[d].obj) {
            ...
            for (var u = 0; u < e[d].type.length; u++) {
                var _ = e[d].type[u],
                    w = e[d].obj.id;
                if (l = "", (i = t.querySelectorAll(".js-rule-error-" + _)).length)
    ...
    if (t || !document.body.classList.contains("t706__body_cartwinshowed") && !document.body.classList.contains("t706__body_cartpageshowed") || (e = document.querySelector(".t706")), e) {
        ...
        if (r) {
            ...
            if (r.classList.contains("t-form__inputsbox_inrow") || (o = e.querySelectorAll(".t-input-block_width")), 0 !== o.length) {
                (r.classList.contains("t-form__inputsbox_vertical-form") || r.closest(".t706")) && r.classList.add("t-form__inputsbox_flex"), r.closest(".t706") && r.classList.add("t-form__inputsbox_inrow");
                var a = r.offsetWidth,
...
function t_forms__onSuccess(t) {
    ...
    var e = t.closest(".r"),
        ...
        s, l, c = o.clientHeight - (n + i) + (o.getBoundingClientRect().top + window.pageYOffset),
    ...
    if (A && setTimeout((function() {
        ...
        var x = e.querySelector(".t" + r + "__btn_prev"),
            F = e.querySelector(".t" + r + "__wrapper"),
            S = e.querySelector(".t" + r + "__quiz-form-wrapper");
        x && (x.style.display = "none"), F && (F.style.minHeight = ""), S && (S.style.minHeight = "")
    }
}
