        ...
        if (i)
            if (!i.getAttribute("data-slider-initialized")) {
                ...
                if (d) {
                    ...
                    S ? y = parseInt(S, 10) : i.setAttribute("data-slider-pos", 1), i.setAttribute("data-slider-cycle", ""), i.setAttribute("data-slider-animated", ""), a || t_slds__createDummies(o, n, i), u = parseInt(i.getAttribute("data-slider-items-in-row"), 10) || 0;
...
function t_slds_animate(t, e, s) {
    ...
    requestAnimationFrame((function t_slds_animate(r) {
        ...
        a > 1 && (a = 1);
        var d = t(a);
        e(d), a < 1 ? requestAnimationFrame(t_slds_animate) : "y" !== window.lazy && "yes" !== document.querySelector("#allrecords").getAttribute("data-tilda-lazy") || t_slds_onHammerLoad("t_lazyload_update", (function() {
            t_lazyload_update()
        }))
    }))
}
        ...
        if (a) {
            ...
            if (d) {
                ...
                var stopSliderIfNeed = function(t) {
                    ...
                    _ = "ontouchend" in document ? "data-slider-touch" : "data-slider-stopped",
                    p;
                if ("IntersectionObserver" in window) new IntersectionObserver((function(t) {
                    var e = t[0];
                    d.setAttribute(_, e.isIntersecting ? "" : "yes")
                })).observe(r);
                else stopSliderIfNeed(_), window.addEventListener("scroll", (function() {
                    c = !0, clearTimeout(n), n = setTimeout((function() {
                        stopSliderIfNeed(_), c = !1
                    }), 250)
                }));
                if (1 == e) return !1;
